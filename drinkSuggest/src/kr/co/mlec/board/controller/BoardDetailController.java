...
// 게시글 내용 조회 
	 ...
	 * 
	 * BoardService service = new BoardService(); // 해당게시글 +첨부파일 조회 Map<String,
	 * Object> result = service.detailBoard(no);
	 * 
	 * BoardVO board = (BoardVO)result.get("board"); List<BoardFileVO> fileList =
	 * (List<BoardFileVO>)result.get("fileList");
	 * 
	 * 
	 * 
	 * MentionService mservice = new MentionService(); ArrayList<MentionVO>
	 * mentionList = mservice.selectMentionList(no);
	 * 
	 * 
