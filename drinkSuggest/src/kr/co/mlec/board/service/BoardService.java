...
public class BoardService {
	 ...
	 */
	/*
	 * public Map<String, Object> detailBoard(int no) { // 1. BoardVO board =
	 * boardDao.selectBoardByNo(no); boardDao.updateCnt(no);
	 * 
	 * // 2. List<BoardFileVO> fileList = boardDao.selectFileByNo(no);
	 * 
	 * Map<String, Object> data = new HashMap<>(); data.put("board", board);
